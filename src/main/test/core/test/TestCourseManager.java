...
public class TestCourseManager {
	...
	@Test
	public void testCreateClassWith1000Cap() {
		this.courseManager.createClass("ECS161", 2017, "Instructor", 1000);
		assertFalse(this.courseManager.classExists("ECS161", 2017));
	}
	
	@Test
	public void testCreateClassWith0Cap() {
		this.courseManager.createClass("ECS161", 2017, "Instructor", 0);
		assertFalse(this.courseManager.classExists("ECS161", 2017));
	}
	
	@Test
	public void testCreateClassWithNegativeCap() {
		this.courseManager.createClass("ECS161", 2017, "Instructor", -1);
		assertFalse(this.courseManager.classExists("ECS161", 2017));
	}
	
	@Test
	public void testCreateClassInstructorConstraint() {
		this.courseManager.createClass("ECS161", 2017, "Instructor", 10);
		this.courseManager.createClass("ECS165", 2017, "Instructor", 10);
		//when(mockAdmin.createClass(Mockito.anyString(), 2017, "Instructor", Mockito.anyInt()));
		Mockito.doNothing().when(this.admin).createClass(Mockito.anyString(), Mockito.eq(2017), Mockito.contains("Instructor"), Mockito.anyInt());
		this.courseManager.createClass("ECS150", 2017, "Instructor", 10);
		Mockito.verify(this.admin, Mockito.atMost(2)).createClass(Mockito.anyString(), Mockito.anyInt(), Mockito.anyString(), Mockito.anyInt());
	}
	
	@Test
	public void testCreateClassNoSameNameAndYear() {
		this.courseManager.createClass("ECS161", 2017, "Instructor", 10);
		this.courseManager.createClass("ECS161", 2017, "Instructor", 10);
		Mockito.verify(this.admin, Mockito.atMost(1)).createClass(Mockito.anyString(), Mockito.anyInt(), Mockito.anyString(), Mockito.anyInt());
	}
}
